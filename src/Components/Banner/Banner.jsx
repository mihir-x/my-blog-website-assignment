...
const Banner = () => {
    ...
    return (
        <div className="max-w-screen-lg mx-auto bg-gray-500 h-[400px] mt-5 md:mt-12 flex items-center gap-5 md:gap-10">
            ...
            >
                <h1 className="text-xl text-white md:text-4xl p-2 md:p-8 font-bold text-center mt-5 md:mt-10"><span className="text-sky-400 ">Explore, Learn, Inspire:</span> Your Daily Source of Knowledge</h1>
            </motion.div>
